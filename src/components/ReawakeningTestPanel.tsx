...
export function ReawakeningTestPanel() {
  ...
  return (
    <SystemPanel className="mt-3 flex flex-col gap-3">
      <p className="font-system text-[11px] tracking-[0.12em] text-mana uppercase">Reawakening Test</p>
      <p className="text-xs text-ink-soft">
        Every measurement on file is 8 to 12 weeks old. Rank and tonnage read off the numbers given at
        the Awakening — a fresh reading keeps them honest. Waist, neck and hip stay optional.
      </p>
      <NumberField
        label="Bodyweight"
      ...
      <button
        ...
        onClick={submit}
        className={`self-start rounded px-3 py-1.5 font-system text-[10px] uppercase ${
