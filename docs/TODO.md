...
| Bundle | 208.96 KB JS + 6.58 KB CSS + 2.20 KB `workbox-window` ≈ 217.7 KB gzipped initial route, under half the ~480 KB Slow-4G budget. The Hunter License card, the QR scanner, and now `ExerciseHelpModal` (the anatomy atlas SVGs live here — 106.95 KB gzipped, paid only the first time a hunter opens a "?") ship as their own lazy chunks — Tower, Shadow Army and Shop were folded back into the main bundle 2026-09-10 (each under 1 KB, not worth Suspense's timing cost) |
